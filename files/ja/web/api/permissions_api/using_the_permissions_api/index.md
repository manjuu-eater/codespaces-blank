...
![英国 Greenfield の地図を表示したスクリーンショット。](https://developer.mozilla.org/en-US/docs/web/api/permissions_api/using_the_permissions_api/location-finder-with-permissions-api.png)
